              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@example.com" className="text-white hover:text-accent">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+11234567890" className="text-white hover:text-accent">
                      +91 8934856824
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white">Lumbini,Nepal</p>
                  </div>
                </div>
              </div>
